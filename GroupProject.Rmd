...
full.model <- glm(Approved ~ grp.Debt + grp.Age + grp.Income + Gender + BankCustomer + Ethnicity + grp.YearsEmployed + PriorDefault + Employed + CreditScore + DriversLicense + Citizen + Married,
...
# Fit the logistic regression model
reduced.model <- glm(Approved ~ grp.Income + grp.Debt + CreditScore + Employed + BankCustomer + PriorDefault, 
